-- Ejecutar TODO este bloque en Supabase (crea tablas + catálogo de zonas actualizado).
-- Sirve aunque nunca hayas corrido la migración 004.
...
ALTER TABLE zonas_distribucion DROP CONSTRAINT IF EXISTS zonas_distribucion_nombre_key;
...
-- Zona retirada del catálogo (solo si existía)
DELETE FROM asesor_zonas WHERE codigo_zona = '1CEX01';
DELETE FROM zonas_distribucion WHERE codigo = '1CEX01';
